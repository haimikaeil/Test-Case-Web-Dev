...
function getBackgroundColorsn() {
	var colorThief = new BackgroundColorTheif();
	var rgb = colorThief.getBackGroundColorsn(document.getElementById("backgroundImagesn"));
	/*console.log('background-color = '+rgb);*/
	document.getElementById("backGroundColorsn").style.backgroundColor = 'rgb(' + rgb[0] + ',' + rgb[1] + ',' + rgb[2] +')';
}
